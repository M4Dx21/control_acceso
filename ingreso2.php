...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" id="form-ingreso">
            <input type="text" name="rut" placeholder="RUT" required id="rut" oninput="buscarRut()" onblur="validarRUTInput()">
            ...
            <input type="text" name="empresa" placeholder="Empresa perteneciente" required id="empresa">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $fecha_ingreso = new DateTime($persona['fecha_ingreso']);
                                echo $fecha_ingreso->format('d/M/Y H:i');
                            ?>
                        </td>
                        <td>
